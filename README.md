...
- Click the green button at the top of this page that says "Clone or Download" and select "Download ZIP". Github will now ZIP the original ZIP-file I uploaded, we will be using the ZIP-file "Skins.ZIP" inside of the file you downloaded.
...
- Open the ZIP-file you downloaded and drag&drop/extract the folder named "Skins" to the location you found. Click yes when prompted to merge/replace the already existing folder with your zipped folder. Your structure should look like this: *Documents\Rainmeter\Skins\Chleon-Player*
